...
var YouziGuessLike = /** @class */ (function (_super) {
    ...
    YouziGuessLike.prototype.initShow = function () {
        ...
        this.visible = true;
        this.guessUI.visible = true;
        this.notifyUIComplete(YouziData_1.YOUZI_UI_ID.Youzi_GuessLike, { complete: true });
        this.notifyUIState(YouziData_1.YOUZI_UI_ID.Youzi_GuessLike, { uiVisible: true });
    ...
    YouziGuessLike.prototype.onGuessLikeItemMouseEvent = function (e, index) {
        if (e.type == 'mousedown') {
            ...
            if (!this.isClick) {
                ...
                YouziData_1.YouziData.clickGameYouziUIId = YouziData_1.YOUZI_UI_ID.Youzi_GuessLike;
...
}(layaMaxUI_1.ui.youzi.Youzi_GuessLikeUI));
exports["default"] = YouziGuessLike;
