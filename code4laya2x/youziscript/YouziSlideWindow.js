...
var YouziSlideWindow = /** @class */ (function (_super) {
    ...
    YouziSlideWindow.prototype.showSlideWindow = function () {
        ...
        if (!this.SlideWindowUI.visible) {
            ...
            this.slideWindowActionShow(function () {
                self.notifyUIState(YouziData_1.YOUZI_UI_ID.Youzi_SlideWindow, { uiVisible: true });
                if (!self.showFirst) {
                    self.showFirst = true;
                    self.checkExposure();
                }
    ...
    YouziSlideWindow.prototype.closeSlideWindow = function () {
        ...
        this.slideWindowActionClose(function () {
            ...
            self.notifyUIState(YouziData_1.YOUZI_UI_ID.Youzi_SlideWindow, { uiVisible: false });
        });
    ...
    YouziSlideWindow.prototype.initShow = function () {
        this.hotlistDatas = YouziData_1.YouziData.hotListDatas;
        ...
        if (this.hotlistDatas.length > 0) {
            ...
            this.notifyUIComplete(YouziData_1.YOUZI_UI_ID.Youzi_SlideWindow, { complete: true });
        }
    };
    ...
    YouziSlideWindow.prototype.checkSendExpsureLog = function (index) {
        if (this.visible && this.SlideWindowUI.visible) {
            if (!this.slideItemExposure[this.hotlistDatas[index].appid]) {
                ...
                YouziData_1.YouziData.sendExposureLog(this.hotlistDatas[index], YouziData_1.BI_PAGE_TYPE.FLOAT);
...
}(layaMaxUI_1.ui.youzi.Youzi_SlideWindowUI));
exports["default"] = YouziSlideWindow;
