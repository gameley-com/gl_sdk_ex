...
module YouziDataModule{
     ...
     */
    export var AllDataAnimaTypeJson = {};
    ...
    export const YOUZI_UI_ID = {
        Youzi_BottomBanner:1,//底部单行游戏推荐矩阵,位置只能靠近屏幕底部
        Youzi_GameBanner:2,//底部横幅游戏推荐，效果应该类似于微信banner（横幅）广告
        Youzi_GuessLike:3,//单行竖屏浮动猜你喜欢，位置自定所以是浮动
        Youzi_GuessLikeH:4,//单列横屏浮动猜你喜欢，位置自定所以是浮动
        Youzi_MainPush:5,//主推，一个会自动切换游戏icon图片的Sprite
        Youzi_MoreGame:6,//竖屏更多游戏推荐
        Youzi_MoreGameH:7,//横屏更多游戏推荐
        Youzi_OffLine:8,//竖屏离线推荐
        Youzi_OffLineH:9,//横屏离线推荐
        Youzi_SlideWindow:10,//竖屏抽屉
        Youzi_SlideWindowH:11,//横屏抽屉
        Youzi_SmallWall:12,//大家都在玩儿竖屏
        Youzi_SmallWallH:13 //大家都在玩儿横屏
    }

    export var YouziData =
    {
        SdkVersion : 'laya1.7.6-v6.1',                                                       //当前SDK版本
        resVersion : '1.00.00',                                                             //中心化资源版本
        debug : false,                                                                      //当前是否是测试服
        appid : '',                                                                         //渠道提供的appid
        channelId : 1002,                                                                   //管理后台提供的平台渠道
        miniGamePlatType:0,                                                                 //平台类型，默认微信
        ...
        _mainRecAmount:1,                     //多主推数量，默认为1个主推
        _gameIndexArrLength:1,                //随机数组长度
        _gameIndexArr:[],                     //随机数组
        /**
         * 中心化初始化函数 调用一次即可
