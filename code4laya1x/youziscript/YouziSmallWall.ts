module YouziSmallWall_Module{
    export class YouziSmallWall extends ui.youzi.Youzi_SmallWallUI{
        ...
        private onSmallWallListItemMouseEvent(e:Event,index:number):void
        {
            if(e.type == 'mousedown'){
                ...
                if(!this.isClick){
                    ...
                    if(tmpData.hotred == 1){
                        var tmpSlideHit:Laya.Image = this.smallWallList.getCell(index).getChildByName('icon').getChildByName('redhit') as Laya.Image;
